...
basepath="/project/cas/islas/python_savs/CAM7_vertres_paper/RAW_DATA/80km_new/ZMfluxes/"
...
for iexp in expname:
    ...
    uzm.to_netcdf(outdir+iexp+"_80km_new.nc")
    epfy.to_netcdf(outdir+iexp+"_80km_new.nc", mode="a")
    epfz.to_netcdf(outdir+iexp+"_80km_new.nc", mode="a")
    vtem.to_netcdf(outdir+iexp+"_80km_new.nc", mode="a")
    wtem.to_netcdf(outdir+iexp+"_80km_new.nc", mode="a")
    psitem.to_netcdf(outdir+iexp+"_80km_new.nc", mode="a")
    utendepfd.to_netcdf(outdir+iexp+"_80km_new.nc", mode="a")
    utendvtem.to_netcdf(outdir+iexp+"_80km_new.nc", mode="a")
    utendwtem.to_netcdf(outdir+iexp+"_80km_new.nc", mode="a")
    dudt.to_netcdf(outdir+iexp+"_80km_new.nc", mode="a")
