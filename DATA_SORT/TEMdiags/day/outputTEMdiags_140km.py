...
for iexp in expname:
    ...
    uzm.to_netcdf(outdir+iexp+"_140km.nc")
    epfy.to_netcdf(outdir+iexp+"_140km.nc", mode="a")
    epfz.to_netcdf(outdir+iexp+"_140km.nc", mode="a")
    vtem.to_netcdf(outdir+iexp+"_140km.nc", mode="a")
    wtem.to_netcdf(outdir+iexp+"_140km.nc", mode="a")
    psitem.to_netcdf(outdir+iexp+"_140km.nc", mode="a")
    utendepfd.to_netcdf(outdir+iexp+"_140km.nc", mode="a")
    utendvtem.to_netcdf(outdir+iexp+"_140km.nc", mode="a")
    utendwtem.to_netcdf(outdir+iexp+"_140km.nc", mode="a")
    dudt.to_netcdf(outdir+iexp+"_140km.nc", mode="a")
