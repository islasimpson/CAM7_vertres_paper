...
basepath="/project/cas/islas/python_savs/CAM7_vertres_paper/RAW_DATA/JRA55/dayfrom6h/"
...
dat = xr.open_mfdataset(basepath+"*.nc").w.sel(pre=500)
...
mjofilt = mjofilt.rename('MJO_OMEGA500')

mjofilt.to_netcdf(pathout+"OMEGA500_mjo_JRA55.nc")
uqbo.to_netcdf(pathout+"OMEGA500_mjo_JRA55.nc", mode="a")
