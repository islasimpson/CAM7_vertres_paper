...
dat = xr.open_mfdataset(basepath+"/*.nc").W.sel(level=500)
...
udat = xr.open_dataset(ubasepath+'ERA5.nc')
...
mjofilt.to_netcdf(pathout+"OMEGA500_mjo_ERA5.nc")
uqbo.to_netcdf(pathout+"OMEGA500_mjo_ERA5.nc", mode="a")
