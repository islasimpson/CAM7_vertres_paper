...
#    basepath="/project/cas/islas/python_savs/L83_paper/DATA_SORT/zonalmean/mon/80km/"
#    var=['BUTGWSPEC','UTGWORO','UTGWSPEC']
#    gwd=[]
#
#    for ivar in var:
#        dat = xr.open_mfdataset(basepath+iexp+"/"+ivar+"_80km.nc")
...
#    alldat = xr.merge([tem_tr, gwd_tr])
    ...
    comp.to_netcdf(pathout+iexp+"_composite_80km_new_50hpa.nc")
