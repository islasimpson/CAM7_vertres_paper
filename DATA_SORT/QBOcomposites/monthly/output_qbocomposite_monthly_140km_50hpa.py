...
#expnames=['dz1000']
expnames=['dz1000','dz900','dz800','dz700','dz600','dz500','dz400']
...
for iexp in expnames:
    ...
    basepath="/project/cas/islas/python_savs/CAM7_vertres_paper/DATA_SORT/zonalmean/140km/mon/"
    ...
    comp.to_netcdf(pathout+iexp+"_composite_50hpa.nc")
