...
basepath="/project/mojave/observations/MERRA2/day/OLR/"
ubasepath="/project/cas/islas/python_savs/CAM7_vertres_paper/RAW_DATA/MERRA2/Uzm/"
pathout="/project/cas/islas/python_savs/CAM7_vertres_paper/DATA_SORT/MJO_OLR/"

dat = xr.open_mfdataset(basepath+"*.nc").LWTUP
dat = dat.where( ~(( dat.time.dt.month == 2) & (dat.time.dt.day == 29)), drop=True)
dat.time.encoding['calendar'] = 'noleap'
dat = dat.sel(time=slice("1980-01-01","2023-12-31"))
...
udat['time'] = pd.date_range("1980-01","2024-01", freq='M')
...
mjofilt.to_netcdf(pathout+"OLR_mjo_MERRA2.nc")
uqbo.to_netcdf(pathout+"OLR_mjo_MERRA2.nc", mode="a")
