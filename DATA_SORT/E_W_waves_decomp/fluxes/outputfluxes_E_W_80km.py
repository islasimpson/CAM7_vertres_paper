...
expname=['dz800','dz700','dz600','dz500']

basepath="/project/cas/islas/python_savs/CAM7_vertres_paper/RAW_DATA/80km/day/plev/day_from_6h/"
...
for iexp in expname:
    ...
    ds.load().to_netcdf(pathout+'fluxes_E_W_stat_'+iexp+'_80km.nc')
